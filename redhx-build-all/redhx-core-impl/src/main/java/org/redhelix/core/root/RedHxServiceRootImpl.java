...
import org.redhelix.core.service.root.RedHxServiceRoot;
 ...
 * @author Hank Bruning
 */
public final class RedHxServiceRootImpl implements RedHxServiceRoot {
  ...
  public RedHxServiceRootImpl(RedHxRedfishProtocolVersionEnum protocolVersion,
      RedHxRedfishSchemaVersionEnum schemaVersion, RedHxAccountService accountService,
      RedHxChassisCollection chassisCollection,
      RedHxComputerSystemCollection computerSystemCollection, RedHxEventService eventService,
      RedHxManagerCollection managerCollection, RedHxMessageVignette messageVignette,
      RedHxMessageVignetteRegistryFileCollection messageVignetteRegistryFileCollection,
      RedHxSchemaFileCollection schemaFileCollection, RedHxSessionCollection sessionCollection,
      RedHxSessionService sessionService, RedHxTaskService taskService) {
    super();
  ...
  public boolean equals(Object obj) {
    ...
    } else if (!messageVignetteRegistryFileCollection
        .equals(other.messageVignetteRegistryFileCollection)) {
      return false;
    }
